...
function Reviews({ bg, bgTop, desc, list, listTitle, action, title, anchor, Id, promptTitle, promptMessage }: Props) {
  ...
  return (
    <section id={anchor} className={`bg${bg} m-reviews`}>
      <div className="double-container">
        <div className={`double-col`}>
          ...
          <div className="animated-content">
            <img
              src={require("../../assets/hand-ok-m.webp")}
              loading="lazy"
              alt="ok"
              className="animated-hand z1 spring-animation elevate"
            />
        ...
        <div className={`double-col bg${bgTop}`}>
          <div className="reviews-box">
            ...
            <div className="review-container">
              ...
              <div className="reviews-controller z1 mb16">
                <div className="control-box frc g10">
